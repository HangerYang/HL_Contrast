...
def main():
    ...
    gconv1 = GConv(input_dim=data.num_features, hidden_dim=512, num_layers=2).to(device)
    gconv2 = GConv(input_dim=data.num_features, hidden_dim=512, num_layers=2).to(device)
    ...
    print(f'(E): MVGRL: Best test accuracy={test_result["accuracy"]:.4f}')
