...
def main():
    ...
    for i in range(10):
        ...
        aug1, aug2 = get_augmentor(args.aug_type, one_side, args.aug_side, args.aug, args.aug2)
    ...
    with open('./results/FB_Aug__{}_{}_{}_{}.csv'.format(args.dataset, args.loss_type, args.aug_type, args.aug_side), 'a+') as file:
        file.write('\n')
