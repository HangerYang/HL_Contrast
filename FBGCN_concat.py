...
def main():
    ...
    test_result = test(high_model, low_model, data)
    with open('./results/nc_FBGCN_concat_{}_{}.csv'.format(args.dataset, args.loss_type), 'a+') as file:
        file.write('\n')
        ...
        file.write(f'(E): FBGCN_concat: Best test accuracy={test_result["accuracy"]:.4f}')
